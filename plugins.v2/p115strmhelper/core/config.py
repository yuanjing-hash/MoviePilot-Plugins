...
class BaseConfig(BaseModel):
    ...
    # 刷新媒体服务器
    transfer_monitor_mediaservers: List[str] = []
    # 刷新媒体服务器开关
    ...
    increment_sync_mediaservers: List[str] = []
    ...
    monitor_life_mediaservers: List[str] = []
    monitor_life_event_modes: List[str] = []
    ...
    directory_upload_path: List[Dict] = []
